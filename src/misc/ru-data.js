    ...
    articlesList: [
      {
        ...
        texts: [
          ...
          },
          {
            ...
            Для подробных условий получения зеленых, необходимо пройти регистрацию (завернута ссылка на ленд) и написать менеджеру Trafflab промокод КОСАРЬ (завернута ссылка на тг). 
            
            Верим в мирное, прибыльное арбитражное будущее, основанное на уважении и доверии партнеров. Если ты разделяешь нашу веру - ждем тебя в Trafflab (ссылка)
            `
          },
        ],
      },
